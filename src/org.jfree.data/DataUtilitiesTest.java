...
public class DataUtilitiesTest extends DataUtilities {
    ...
    public void equalOneNull() {
        double [][] a = {{0},{1}};
        boolean result = DataUtilities.equal(null, a);
        assertEquals(false, result);
    }

    @Test
    public void equalOtherOneNull() {
        double [][] a = {{0},{1}};
    ...
    public void testCalculateColumnTotalNull(){
        DataUtilities.calculateColumnTotal(null, 8);
    }
    ...
    public void testCalculateColumnTotalValidRowsNull(){
        int[] validRows = {0,1,4};
        DataUtilities.calculateColumnTotal(null, 8, validRows);
    }
    ...
    public void testCalculateRowTotalNull(){
        DataUtilities.calculateRowTotal(null, 8);
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testCalculateRowTotalValidRowsNull(){
        int[] validRows = {0,1,4};
        DataUtilities.calculateRowTotal(null, 8, validRows);
    }
